...
Those tests included in the tests folders of the following repositories `api_circuit` and `api_garble` wil demomstrate respectively:
...
The following software/libs are required to compile and run the  tests
- go
- ipfs
- cmake >= 3.22
- bison
...
- liboost-filesystem-dev
 ...
 [Prerequiste Install if needed](./prerequisite_install.md)
